	...
	<div >
		<div class="login-box">
			...
			<div class="login-content">
				<el-row>
					<h2 :span="24" class="login-tit">用户登录</h2>
				</el-row>
				<el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="0" class="demo-ruleForm">
				  ...
				  <el-form-item label="" prop="name" class="login-item">
				  		<el-input type="password" class="login-input" v-model="ruleForm.password" placeholder="密码"></el-input>
				  </el-form-item>
				  <el-form-item class="text-c" style="margin-top: 20px;">
...
<script>
	import {userLoginAdmin} from '@/api/admin'
    ...
    methods: {
      submitForm(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
			let data = {
			  name: md5(this.ruleForm.name),
			  password: md5(this.ruleForm.password)
			}

			userLoginAdmin(data).then((res)=>{
				console.log('res', res);
				if(res.status == '1'){
